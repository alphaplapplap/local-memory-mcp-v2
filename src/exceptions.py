...
class SecurityError(MemorySystemError):
    ...
    def __init__(self, message: str, threat_type: str = None, client_id: str = None, **kwargs):
        details = kwargs.get('details', {})
        if threat_type:
...
class EmbeddingError(MemorySystemError):
    ...
    def __init__(self, message: str, model: str = None, content_length: int = None, **kwargs):
        details = kwargs.get('details', {})
        if model:
            details['model'] = model
        if content_length:
...
class ConsolidationError(MemorySystemError):
    ...
    def __init__(self, message: str, domain: str = None, operation: str = None, **kwargs):
        details = kwargs.get('details', {})
        if domain:
...
class RateLimitError(MemorySystemError):
    ...
    def __init__(self, message: str, client_id: str = None, limit: int = None, **kwargs):
        details = kwargs.get('details', {})
        if client_id:
            details['client_id'] = client_id
        if limit:
...
class TimeoutError(MemorySystemError):
    ...
    def __init__(self, message: str, operation: str = None, timeout: float = None, **kwargs):
        details = kwargs.get('details', {})
        if operation:
            details['operation'] = operation
        if timeout:
...
class InsufficientDataError(MemorySystemError):
    ...
    def __init__(self, message: str, required: int = None, available: int = None, **kwargs):
        details = kwargs.get('details', {})
        if required:
...
class ResourceExhaustedError(MemorySystemError):
    ...
    def __init__(self, message: str, resource_type: str = None, current_usage: int = None, limit: int = None, **kwargs):
        details = kwargs.get('details', {})
        if resource_type:
